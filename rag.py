...
3. If you find the answer, write the answer in a concise way and add the list of sources that are used to derive the answer. Exclude the sources that are irrelevant to the final answer.
""")
query = "how to debug .net application CPU usage in rider"
